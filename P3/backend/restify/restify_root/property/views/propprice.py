...
from ..serializers import PropCreateSerializer, ActivatePropSerializer
from ..serializers import PropSearchSerializer, PropQuerySerializer, UserPropSerializer

from ..models import PropData, Amenity, PropQuery, ActiveProp
...
class priceProp(ListAPIView):
    ...
    def get_queryset(self):
        ...
        return ActiveProp.objects.filter(pid=uid)
...
class ppUpdate(RetrieveUpdateDestroyAPIView):
